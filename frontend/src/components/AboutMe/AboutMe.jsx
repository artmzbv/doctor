...
import './AboutMe.css'; 
import doctor from '../../images/sticker.webp'
...
const AboutMe = () => {
    return (
        <section className='aboutme' id='aboutme'>
          ...
          <p className='aboutme__text'>Зубова О.М.  -  гинеколог-эндокринолог, к.м.н с фокусом на нарушения менструального цикла, климактерический синдроме, эндометриозе,  подборе контрацепции в различные периоды жизни женщины, подготовке к беременности 
